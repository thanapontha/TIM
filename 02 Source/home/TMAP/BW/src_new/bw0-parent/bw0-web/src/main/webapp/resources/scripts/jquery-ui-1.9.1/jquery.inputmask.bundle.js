        ...
        $.fn.inputmask = function (fn, options) {
            ...
            function maskScope(masksets, activeMasksetIndex) {
                ...
                this.mask = function (el) {
					...
					var selector = opts.selector || $input;
					alert( opts.selector );
                    $input.off(".inputmask");;//$input.unbind(".inputmask");
                    $input.removeClass('focus.inputmask');
                    //bind events
                    $input.on("mouseenter.inputmask", selector,function () {
                        var $input = $(this), input = this;
                    ...
                    }).on("blur.inputmask", selector,function () {
                    ...
                    }).on("focus.inputmask", selector,function () {
                    ...
                    }).on("mouseleave.inputmask", selector,function () {
                        var $input = $(this), input = this;
                        if (opts.clearMaskOnLostFocus) {
                    ...
                    }).on("click.inputmask", selector,function () {
                        var input = this;
                        setTimeout(function () {
                    ...
                    }).on('dblclick.inputmask', selector,function () {
                        var input = this;
                    ...
                    }).on("keydown.inputmask", selector,keydownEvent
                    ).on("keypress.inputmask", selector,keypressEvent
                    ).on("keyup.inputmask", selector,keyupEvent
                    ).on(pasteEvent + ".inputmask dragdrop.inputmask drop.inputmask", function () {
                    ...
                    }).on('setvalue.inputmask', selector,function () {
                        var input = this;
                        getActiveMaskSet()["undoBuffer"] = input._valueGet();
                        checkVal(input, true);
                        if (input._valueGet() == getActiveBufferTemplate().join(''))
                            input._valueSet('');
                    }).on('complete.inputmask', selector,opts.oncomplete)
                        .on('incomplete.inputmask', selector,opts.onincomplete)
                        .on('cleared.inputmask', selector,opts.oncleared);
