    ...
    $.fn.fixedHeaderTable = function(method) {
	     ...
	     */
            setup: function(options) {
                ...
                if (settings.contentWidth.search('%') > -1) {
					var widthMinusScrollbar = $self.parent().width();
                } else {
                    var widthMinusScrollbar = settings.contentWidth;
                }
                if ( $self.height() + $self.find( 'thead' ).height() >= settings.height )
