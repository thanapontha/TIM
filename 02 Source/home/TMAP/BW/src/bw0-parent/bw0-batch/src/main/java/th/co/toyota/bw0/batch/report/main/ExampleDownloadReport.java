...
public class ExampleDownloadReport {
	...
	final Logger logger = LoggerFactory.getLogger(ExampleDownloadReport.class);
	protected IST30000LoggerDb loggerBBW04221;
	protected MessageSource messageSource;
	protected SystemMasterRepository systemRepository;
	protected CommonAPIRepository commonRepository;
	protected ExampleDownloadReportRepository repository;
