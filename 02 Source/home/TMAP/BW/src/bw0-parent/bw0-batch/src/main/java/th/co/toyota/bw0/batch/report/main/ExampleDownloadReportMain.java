...
import th.co.toyota.bw0.batch.report.repository.ExampleDownloadReportRepository;
...
@Component
public class ExampleDownloadReportMain {

	final Logger logger = LoggerFactory.getLogger(ExampleDownloadReportMain.class);
	...
	@Autowired
	private ExampleDownloadReportRepository repository;
	...
	public static void main(String[] args) {
		...
		ExampleDownloadReportMain main = appContext.getBean(ExampleDownloadReportMain.class);
	...
	public List<String> generateReport(String[] args) throws CommonErrorException {
		ExampleDownloadReport download = new ExampleDownloadReport();
