...
@Repository
public class SystemMasterAPIRepositoryImp implements SystemMasterRepository {
	@NotNull
	@PersistenceContext(unitName = "entityManagerFactory")
	private EntityManager em;

	final Logger logger = LoggerFactory.getLogger(SystemMasterAPIRepositoryImp.class);
