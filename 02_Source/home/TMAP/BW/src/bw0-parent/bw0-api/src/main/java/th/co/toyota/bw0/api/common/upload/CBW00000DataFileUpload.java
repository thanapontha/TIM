 ...
 * Program ID 	            :  CBW00000DataFileUpload.java
...
public class CBW00000DataFileUpload {
    ...
    public List<String> gmHeaderChk = new ArrayList<>();
    ...
    public Object[] convertExcelToStaging(String fileName, String functionId, String userID,String stagingTbName, boolean checkFileSize, HashMap<String, String[]> paramHeaderChk, String deleteStageSQL) throws CommonErrorException {
        ...
        try {	        	
            ...
            try(FileInputStream file = new FileInputStream(new File(targetFolder + fileName))) {
            ...
            if(!validHeader){
            	if(!alreadyLoggedInvaidTemplate){
    ...
    protected String createNameListFile(List<String> filenameList, String fileID) {
        ...
        String filename = fileID + "_" + System.currentTimeMillis();
		...
		try {
            ...
            if(checkFileSize){
            	try(InputStream is = new FileInputStream( uploadFile )) {
			        ...
			        if (iFileSize > maxFileSizeChk) {
			        	BigDecimal fileSizeMB = BigDecimal.valueOf(iFileSize/(1024.0)); 
	        	...
	        	try{
	                ...
	                if(detailMap != null){
		                ...
		                if(convertToNumberic!=null && convertToNumberic.equalsIgnoreCase("Y") && !Strings.isNullOrEmpty(cellValue)){
		        			...
		        			Object[] result = checkAlphaNumeric(mapInfoDetail, cellValueOriginal, rowIdx, col1ofRow);
		                	valid = (boolean)result[0];
		        			cellValue = (String)result[1];  
		        		}else{
		        			cellValue = dataCell.getStringCellValue();
	...
	public String readCellHeaderValue(Cell cell, FormulaEvaluator objFormulaEvaluator){
		...
		return objDefaultFormat.formatCellValue(cell, (FormulaEvaluator)objFormulaEvaluator);
	}
	...
	private Object[] checkAlphaNumeric(HashMap mapInfo, String cellValue, int rowIdx, String colName){
